...
parser.add_argument('--checkpoint_path', default='dgcnn_pytorch/outputs/models/our_model.tar', help='Model checkpoint path [default: None]')
...
TEST_DATASET = our_data(partition='test', num_points=FLAGS.num_points, data_path=custom_dataset)

print('Test dataset len: ', len(TEST_DATASET))
TEST_DATALOADER = DataLoader(TEST_DATASET, num_workers=8, batch_size=FLAGS.batch_size, shuffle=True, drop_last=True)
...
#         MIOU_LOW.append(miou_low_collect)
    ...
    # print("Class LOW IOU AVERAGE: ", CIOU_LOW_AVERAGE)
        ...
        cam = PowerCAM(net, data, cfg, norm=True, cls=eval_class, mode='counterfactual', mask_type='none')
